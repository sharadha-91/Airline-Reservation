...
//DARYL MCALLISTER
//deals with the form in the get island name jsp
@Controller
@RequestMapping("/getIslandNameForm")
public class GetIslandNameFormController {
	...
	public String loadDefault(@RequestParam Map<String,String> requestParams, HttpServletRequest request)
	{
		...
		String island = requestParams.get("txtIslandName"); //get input from text box
